...
def ModuleComplexUnpack(COMP_DWT: int, N_CLK: int, IF_RST_N: bool) -> None:
    ...
    if N_CLK == 0:
        ...
        ModuleDelay(DWT=COMP_DWT, N_CLK=N_CLK, IF_RST_N=IF_RST_N, PORTS=ports_delay_re,)  # type: ignore
        ...
        ModuleDelay(DWT=COMP_DWT, N_CLK=N_CLK, IF_RST_N=IF_RST_N, PORTS=ports_delay_im,)  # type: ignore
