    ...
    if LMMSE_REAL_COEFF:
        ...
        for sym in range(N_OUT_SYMS):
                ...
                for j in range(max_occasions):
                    ...
                    ModuleMul(QU_IN_1=QU_PILOT_COMP, QU_IN_2=QU_COEFF, QU_OUT=QU_PROD, N_CLK=MUL_LATENCY, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.WRP.TCPL, IF_RST_N=True, PORTS=mul_ports_re)  # type: ignore
                    ModuleMul(QU_IN_1=QU_PILOT_COMP, QU_IN_2=QU_COEFF, QU_OUT=QU_PROD, N_CLK=MUL_LATENCY, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.WRP.TCPL, IF_RST_N=True, PORTS=mul_ports_im)  # type: ignore
                ...
                if max_occasions == 1:
                    ...
                    ModuleAdderTree(QU_IN=QU_PROD, QU_OUT=QU_ACC, N_PIPELINES=TREE_DEPTH, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.WRP.TCPL, IF_RST_N=True, N_INPUTS=max_occasions, CONFIG_MODE='A', PORTS=tree_ports_re)  # type: ignore
                    ModuleAdderTree(QU_IN=QU_PROD, QU_OUT=QU_ACC, N_PIPELINES=TREE_DEPTH, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.WRP.TCPL, IF_RST_N=True, N_INPUTS=max_occasions, CONFIG_MODE='A', PORTS=tree_ports_im)  # type: ignore
                    QU_SUM = QU_ACC
                ...
                ModuleFxMatch(QU_IN=QU_SUM, QU_OUT=QU_OUT_COMP, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.SAT.TCPL, N_CLK=0, IF_RST_N=False, PORTS={'i_data': f"sum_re_s{sym}", 'o_data': fxm_re_name})  # type: ignore
                ModuleFxMatch(QU_IN=QU_SUM, QU_OUT=QU_OUT_COMP, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.SAT.TCPL, N_CLK=0, IF_RST_N=False, PORTS={'i_data': f"sum_im_s{sym}", 'o_data': fxm_im_name})  # type: ignore
                ...
                ModuleDelay(DWT=H_DWT, N_CLK=1, IF_RST_N=True, PORTS=delay_ports_sym)  # type: ignore
                #/ 
        ...
        for sym in range(N_OUT_SYMS):
            ...
            for j in range(max_occasions):
                ...
                ModuleComplexMul(QU_IN_1=QU_PILOT_COMP, QU_IN_2=QU_COEFF, QU_OUT=QU_CMUL_OUT, N_CLK=MUL_LATENCY, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.SAT.TCPL, IF_RST_N=True, METHOD='4mul', PORTS=cmul_ports)  # type: ignore
            ...
            if max_occasions == 1:
                ...
                for comp_tag in ['re', 'im']:
                    ...
                    ModuleAdderTree(QU_IN=QU_CMUL_OUT, QU_OUT=QU_ACC, N_PIPELINES=TREE_DEPTH, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.WRP.TCPL, IF_RST_N=True, N_INPUTS=max_occasions, CONFIG_MODE='A', PORTS=tree_ports)  # type: ignore
                ...
                ModuleFxMatch(QU_IN=QU_SUM_C, QU_OUT=QU_OUT_COMP, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.SAT.TCPL, N_CLK=0, IF_RST_N=False, PORTS={'i_data': f"csum_re_s{sym}", 'o_data': fxm_re_name})  # type: ignore
                ModuleFxMatch(QU_IN=QU_SUM_C, QU_OUT=QU_OUT_COMP, QU_MODE=QuMode.TRN.TCPL, OF_MODE=OfMode.SAT.TCPL, N_CLK=0, IF_RST_N=False, PORTS={'i_data': f"csum_im_s{sym}", 'o_data': fxm_im_name})  # type: ignore
