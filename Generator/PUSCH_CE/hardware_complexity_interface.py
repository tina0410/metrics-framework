"""NAND2-equivalent hardware-complexity calculations for PUSCH CE."""
...
def read_ge_area(
    ...
    """Read the unique standard-cell area used as one gate equivalent."""
...
def hardware_complexity_ge_cycles(
    ...
    """Return area in gate equivalents multiplied by latency in cycles."""
...
def evaluate_hardware_complexity(
    ...
    *,
    ...
    """Evaluate predicted and optional measured PUSCH CE complexity."""
