...
@convert
def ModuleSubCppConfig(QU_IN_1: PyTU.QuType, QU_IN_2: PyTU.QuType, QU_OUT: PyTU.QuType, QU_MODE: PyTU.QuMode, OF_MODE: PyTU.OfMode):
...
def ModuleSubCppRun(N_FRAMES):
    ...
    #/         // write input data to Input_Files/sub_i_data_1.txt and Input_Files/sub_i_data_2.txt
    #/         f_i_data_1 << i_data_1.toString() << std::endl;
    #/         f_i_data_2 << i_data_2.toString() << std::endl;
    #/         // write output data to Comparison_Files/sub_o_data.txt
