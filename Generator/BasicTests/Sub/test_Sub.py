...
# Version: 1.0.0
# Date: 2026.9.1
# Description: Pytest verification for Sub
...
from BehavModel_Sub import (
    ModuleSubCppConfig as ModuleCppConfig,
    ModuleSubCppRun as ModuleCppRun,
)
from tb_Sub import ModuleTbSub
...
class Testcase:
    __test__ = False
    DUT_NAME = "Sub"
    CPP_CONFIG_FILE_NAME_PREFIX = "SubCppConfig"
    CPP_RUN_FILE_NAME_PREFIX = "SubCppRun"
...
def test_sub(case: Testcase):
    ...
    compare_file_list = [
        (input_dir / "sub_i_data_1.txt", input_dir / "sub_i_data_2.txt",
         comparison_dir / "sub_o_data.txt", output_dir / "sub_o_data.txt"),
    ]
