...
@convert
def ModuleMulCppConfig(QU_IN_1: PyTU.QuType, QU_IN_2: PyTU.QuType, QU_OUT: PyTU.QuType, QU_MODE: PyTU.QuMode, OF_MODE: PyTU.OfMode):
...
def ModuleMulCppRun(N_FRAMES):
    ...
    #/         // write output data to Comparison_Files/Mul_o_data.txt
