...
# Version: 1.0.0
# Date: 2026.9.1
# Description: Pytest verification for Mul
...
class Testcase:
    __test__ = False
    DUT_NAME = "Mul"
    CPP_CONFIG_FILE_NAME_PREFIX = "MulCppConfig"
    CPP_RUN_FILE_NAME_PREFIX = "MulCppRun"
...
def test_mul(case: Testcase):
    ...
    compare_file_list = [
        (input_dir / "Mul_i_data_1.txt", input_dir / "Mul_i_data_2.txt",
         comparison_dir / "Mul_o_data.txt", output_dir / "Mul_o_data.txt"),
    ]
