...
def ModuleAdd(QU_IN_1:QuType, QU_IN_2:QuType, QU_OUT:QuType, N_PIPELINES = 0, QU_MODE = QuMode.TRN.TCPL, OF_MODE = OfMode.WRP.TCPL, IF_RST_N = False):
    ...
    ModuleFxMatch(QU_IN = QU_IN_1, QU_OUT = QU_IN_FIX, PORTS = inst_ports_fxmatch_1)

    inst_ports_fxmatch_2 = {
        "i_data": "data_2",
        "o_data": "data_2_fixed"
    }
    ModuleFxMatch(QU_IN=QU_IN_2, QU_OUT=QU_IN_FIX, PORTS = inst_ports_fxmatch_2)
...
if __name__ == "__main__":
    ...
    ModuleAdd(QU_IN_1 = QuType(1,0,0), QU_IN_2 = QuType(1,0,0), QU_OUT = QuType(1,0,0), N_PIPELINES = 0, IF_ENABLE = False, IF_RST_N = False) # Sequential
