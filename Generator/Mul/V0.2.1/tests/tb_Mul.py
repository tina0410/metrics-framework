...
try:
    ...
    ModuleMul = getattr(module, f"Module{DUT_NAME}")
...
@convert 
def ModuleTbMul(QU_IN_1, QU_IN_2, QU_OUT, N_CLK, IF_RST_N, QU_MODE, OF_MODE, input_file_dir="../..",N_FRAMES=100, CLK_PERIOD=10):
    #/ `timescale 1ns/1ps
    #/ module TbMul;
    #/ // Inputs
    ...
    #/ // Instantiate the DUT
    ModuleMul(PORTS = inst_ports, QU_IN_1 = QU_IN_1, QU_IN_2 = QU_IN_2, QU_OUT = QU_OUT, N_PIPELINES = N_CLK, QU_MODE=QU_MODE, OF_MODE=OF_MODE, IF_RST_N = IF_RST_N)
    ...
    #/ // Drive input signal
    input_file_name_1 = os.path.join(input_file_dir,"Input_Files/Mul_i_data_1.txt")
    input_file_name_2 = os.path.join(input_file_dir,"Input_Files/Mul_i_data_2.txt")
    ...
    output_file_name = os.path.join(input_file_dir,"Output_Files/Mul_o_data.txt")
