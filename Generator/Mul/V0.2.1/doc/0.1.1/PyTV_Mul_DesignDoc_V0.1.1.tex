...
\begin{document}
    ...
    \chapter{Functionality}
        ...
        \begin{algorithm}[H]
            ...
            \tcp{Calculate Quantization Set for multiplication from input data}
            \texttt{DWT\_FIX = QU\_IN\_1.DWT + QU\_IN\_2.DWT - 1 - QU\_IN\_1.IF\_SIGNED} \&\& \texttt{QU\_IN\_2.IF\_SIGNED;} 
            \BlankLine
            ...
            }\ElseIf{QU\_IN\_1.IF\_SIGNED}{
                \texttt{Sign bit is assigned to data\_1's sign bit}
                \BlankLine
                \textit{Perform the Multiplication}
            }\ElseIf{QU\_IN\_2.IF\_SIGNED}{
