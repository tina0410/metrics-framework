...
class Testcase:
    ...
    def __init__(self, qu_type_in_1:PyTU.QuType, qu_type_in_2:PyTU.QuType, qu_type_out_1:PyTU.QuType, qu_mode, of_mode, if_rst_n, n_clk, n_frames):
        '''
...
def test_my_module(request: pytest.FixtureRequest,Testcase:Testcase):
    ...
    compare_file_list = [
        ("./sim/Input_Files/Mul_i_data_1.txt",
         "./sim/Input_Files/Mul_i_data_2.txt",
         "./sim/Comparison_Files/Mul_o_data.txt", 
         "./sim/Output_Files/Mul_o_data.txt"),
        ]
