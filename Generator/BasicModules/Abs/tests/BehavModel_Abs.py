...
@convert
def ModuleCppConfigAbs(QU_IN: PyTU.QuType, QU_OUT: PyTU.QuType, QU_MODE: PyTU.QuMode, OF_MODE: PyTU.OfMode):
...
@convert
def ModuleCppRunAbs(N_FRAMES: int, DWT_IN: int, FRAC_IN: int, IF_SIGNED_IN: bool):
    #/ // module Abs.cpp
    #/ #include <cmath>
    #/ #include <fstream>
    #/ #include <QuBLAS.h>
