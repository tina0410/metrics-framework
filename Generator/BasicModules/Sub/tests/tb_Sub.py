...
@convert 
def ModuleTbSub(QU_IN_1, QU_IN_2, QU_OUT, N_CLK, IF_RST_N, QU_MODE, OF_MODE, input_file_dir="../..",N_FRAMES=100):
    #/ `timescale 1ns/1ps
    #/ module TbSub;
    #/ // Inputs
    ...
    #/ // Instantiate the DUT
    ModuleSub(PORTS = inst_ports, QU_IN_1 = QU_IN_1, QU_IN_2 = QU_IN_2, QU_OUT = QU_OUT, N_PIPELINES = N_CLK, QU_MODE=QU_MODE, OF_MODE=OF_MODE, IF_RST_N = IF_RST_N)
    ...
    PyTB.Moduledrive_rdy(port_en = "en", port_in = "Input_rdy", port_out = "Output_rdy",clk_period = 10, clk= "clk", start = START_CYCLES, latency = N_CLK, N_excitations=2*(N_FRAMES+10),OUTMODE = "PRINT")
